...
import { filterNavigationByPermission } from 'app/theme-layouts/shared-components/navigation/store/navigationSlice';
...
function FuseNavVerticalLayout1(props: FuseNavigationProps) {
	...
	const filtersNavigation = filterNavigationByPermission(navigation);
